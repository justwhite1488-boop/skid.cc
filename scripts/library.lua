        ...
        function KeyPicker:GetState()
            ...
            elseif KeyPicker.Mode == "Hold" then
                ...
                if SpecialKeys[Key] ~= nil then
                    ...
                    return (UserInputService:IsKeyDown(Enum.KeyCode[Key] :: any) and not UserInputService:GetFocusedTextBox()) or UserInputService:IsKeyDown(Enum.UserInputType[Key] :: any) and not UserInputService:GetFocusedTextBox()
                end
            else
